...
public class WitcheryEntities {
   private final ArrayList<WitcheryEntities.EntityRef> entities = new ArrayList();
   ...
   public WitcheryEntities() {
      ...
      this.COVEN_WITCH = (new WitcheryEntities.LivingRef(110, EntityCovenWitch.class, "covenwitch", this.entities)).addSpawn(2, 1, 1, EnumCreatureType.creature, BiomeGenBase.field_76780_h).addSpawn(1, 1, 1, EnumCreatureType.creature, BiomeDictionary.getBiomesForType(Type.FOREST)).setEgg(1118481, 11523);
   ...
   public List<WitcheryEntities.EntityRef> getEntites() {
   ...
   public static class EntityRef {
      ...
      public EntityRef(int id, Class<? extends Entity> clazz, String name, ArrayList<WitcheryEntities.EntityRef> registry) {
         this(id, clazz, name, 80, 3, registry);
      }

      public EntityRef(int id, Class<? extends Entity> clazz, String name, int range, int updates, ArrayList<WitcheryEntities.EntityRef> registry) {
      ...
      public WitcheryEntities.EntityRef setEgg(int color1, int color2) {
         ...
         EntityList.field_75627_a.put(eggID, new EntityEggInfo(eggID, color1, color2));
         return this;
      }
