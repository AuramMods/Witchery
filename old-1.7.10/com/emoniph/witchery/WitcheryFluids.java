...
public final class WitcheryFluids {
   ...
   public static Item bind(Item bucket, Fluid fluid, int quantity) {
      FluidContainerRegistry.registerFluidContainer(new FluidContainerData(new FluidStack(fluid, quantity), new ItemStack(bucket), new ItemStack(Items.field_151133_ar)));
      return bucket;
   }
}
