...
public class ModelGoblinMog extends ModelBase {
   ...
   public ModelGoblinMog(float f) {
      ...
      this.bipedRightArm.func_78789_a(-3.0F, -2.0F, -2.0F, 4, 14, 4);
      ...
      this.bipedLeftArm.func_78789_a(-1.0F, -2.0F, -2.0F, 4, 14, 4);
      ...
      this.bipedChest.func_78789_a(-4.0F, -2.0F, -5.0F, 8, 4, 4);
      this.bipedChest.func_78793_a(0.0F, 2.0F, 0.0F);
      ...
      this.bipedSkirt.func_78789_a(-4.5F, 0.0F, -2.5F, 9, 11, 5);
      this.bipedSkirt.func_78793_a(0.0F, 12.0F, 0.0F);
      this.bipedSkirt.func_78787_b(64, 64);
      this.bipedSkirt.field_78809_i = true;
   ...
   private void doRender(float par7) {
      if (this.field_78091_s) {
         ...
         this.bipedSkirt.func_78785_a(par7);
