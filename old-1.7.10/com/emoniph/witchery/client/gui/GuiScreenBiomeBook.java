...
public class GuiScreenBiomeBook extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.field_146292_n.add(this.buttonNextPage = new GuiButtonNextPage(1, mid + 120, b0 + 154, true));
      this.field_146292_n.add(this.buttonPreviousPage = new GuiButtonNextPage(2, mid + 38, b0 + 154, false));

      for(int i = this.sections.size() - 1; i >= 0; --i) {
         GuiButton button = new GuiButtonBookmark(3 + i, mid + 160, 12 * i + 10, (Integer)this.sections.get(i), (String)this.sectionNames.get(i));
   ...
   public void func_73863_a(int par1, int par2, float par3) {
      ...
      if (this.biomes.size() > 0 && this.pageIndex >= 0 && this.pageIndex < this.biomes.size()) {
         String pageNumberText = I18n.func_135052_a("book.pageIndicator", new Object[]{this.pageIndex + 1, this.biomes.size()});
         ...
         int maxWidth = true;
         int defaultColor = false;
         byte b0 = (byte)(b0 + this.drawSpiltString(biome.field_76791_y, k + 36, b0 + 32, 116, 0));
         b0 = (byte)(b0 + this.field_146289_q.field_78288_b);
         b0 = (byte)(b0 + this.drawSpiltString("> " + String.format(Witchery.resource("witchery.biomebook.rainfall"), biome.field_76751_G), k + 36, b0 + 32, 116, 0));
         ...
         b0 = (byte)(b0 + this.drawSpiltString("> " + String.format(temperatureFormat, biome.field_76750_F), k + 36, b0 + 32, 116, 0));
         ...
         byte var10000 = (byte)(b0 + this.drawSpiltString("> " + String.format(Witchery.resource("witchery.biomebook.lightning"), this.toYesNo(biome.func_76738_d())), k + 36, b0 + 32, 116, 0));
      }
