...
public class TransformBat {
   ...
   public void render(World worldObj, EntityLivingBase entity, double x, double y, double z, RendererLivingEntity renderer, float partialTicks, boolean frontface) {
      ...
      EntityBat var10000 = this.proxyEntity;
      var10000.field_70173_aa += 2;
      this.proxyRenderer.func_76986_a(this.proxyEntity, x + vec.field_72450_a * 0.75D, y + d3 - 0.6D, z + vec.field_72449_c * 0.75D, frontface ? 0.0F : f1, partialTicks);
      var10000 = this.proxyEntity;
      var10000.field_70173_aa += 5;
