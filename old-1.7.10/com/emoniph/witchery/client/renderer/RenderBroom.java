...
public class RenderBroom extends Render {
   ...
   public void renderBroom(EntityBroom par1EntityBoat, double par2, double par4, double par6, float par8, float par9) {
      ...
      if (f2 > 0.0F) {
         GL11.glRotatef(MathHelper.func_76126_a(f2) * f2 * f3 / 10.0F * (float)par1EntityBoat.getForwardDirection(), 1.0F, 0.0F, 0.0F);
      }
      ...
      this.modelBroom.func_78088_a(par1EntityBoat, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
      GL11.glPopMatrix();
   }
