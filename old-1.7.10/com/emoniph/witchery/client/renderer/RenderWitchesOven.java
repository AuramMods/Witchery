...
public class RenderWitchesOven extends TileEntitySpecialRenderer {
   ...
   public void func_147500_a(TileEntity tileEntity, double d, double d1, double d2, float f) {
      ...
      this.renderWitchesOven(tileEntityYour, tileEntity.func_145831_w(), tileEntity.field_145851_c, tileEntity.field_145848_d, tileEntity.field_145849_e, Witchery.Blocks.OVEN_IDLE);
      GL11.glPopMatrix();
   }
