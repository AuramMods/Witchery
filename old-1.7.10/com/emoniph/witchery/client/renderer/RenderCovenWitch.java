...
public class RenderCovenWitch extends RenderLiving {
   ...
   public void func_82412_a(EntityCovenWitch par1EntityCovenWitch, double par2, double par4, double par6, float par8, float par9) {
      ...
      super.func_76986_a(par1EntityCovenWitch, par2, par4, par6, par8, par9);
   }
   ...
   protected void func_82411_a(EntityCovenWitch par1EntityCovenWitch, float par2) {
      ...
      super.func_77029_c(par1EntityCovenWitch, par2);
      ItemStack itemstack = par1EntityCovenWitch.func_70694_bm();
      if (itemstack != null) {
         GL11.glPushMatrix();
         float f2;
         ...
         this.field_76990_c.field_78721_f.func_78443_a(par1EntityCovenWitch, itemstack, 0);
         if (itemstack.func_77973_b().func_77623_v()) {
            this.field_76990_c.field_78721_f.func_78443_a(par1EntityCovenWitch, itemstack, 1);
         }
