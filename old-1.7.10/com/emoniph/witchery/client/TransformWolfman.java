...
public class TransformWolfman {
   ...
   public void syncModelWith(EntityLivingBase entity, boolean frontface) {
      if (this.proxyEntity == null) {
         this.proxyEntity = new EntityWolfman(entity.field_70170_p);
      ...
      this.proxyEntity.func_70062_b(0, entity.func_70694_bm());
      this.proxyEntity.func_70019_c(entity.func_70113_ah());
      this.proxyEntity.setSitting(entity.func_70115_ae());
      if (entity instanceof EntityPlayer) {
         EntityPlayer player = (EntityPlayer)entity;
         this.proxyEntity.setItemInUse(player.func_71011_bu() == null ? null : player.func_71011_bu().func_77946_l(), player.func_71052_bv());
      }
   ...
   public void render(World worldObj, EntityLivingBase entity, double x, double y, double z, RendererLivingEntity renderer, float partialTicks, boolean frontface) {
      ...
      double d3 = 0.0D - (double)this.proxyEntity.field_70129_M;
      if (this.proxyEntity.func_70093_af() && !(entity instanceof EntityPlayerSP)) {
         d3 -= 0.125D;
      }

      if (this.proxyEntity.func_70115_ae()) {
         Entity ridden = this.proxyEntity.field_70154_o;
         d3 += ridden.func_70042_X();
      }

      this.proxyRenderer.func_76986_a((EntityLiving)this.proxyEntity, x, y + d3, z, frontface ? 0.0F : f1, partialTicks);
   }
