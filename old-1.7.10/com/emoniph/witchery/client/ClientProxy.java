...
public class ClientProxy extends CommonProxy {
   ...
   public void registerRenderers() {
      ...
      this.bindRenderer(BlockPoppetShelf.TileEntityPoppetShelf.class, new RenderPoppetChest(), Item.func_150898_a(Witchery.Blocks.POPPET_SHELF));
      this.bindRenderer(BlockGrassper.TileEntityGrassper.class, new RenderGrassper(), Item.func_150898_a(Witchery.Blocks.GRASSPER));
      this.bindRenderer(BlockDistillery.TileEntityDistillery.class, new RenderDistillery(), Item.func_150898_a(Witchery.Blocks.DISTILLERY_IDLE));
      this.bindRenderer(BlockWitchesOven.TileEntityWitchesOven.class, new RenderWitchesOven(), Item.func_150898_a(Witchery.Blocks.OVEN_IDLE));
      this.bindRenderer(BlockDreamCatcher.TileEntityDreamCatcher.class, new RenderDreamCatcher(), Item.func_150898_a(Witchery.Blocks.DREAM_CATCHER));
      this.bindRenderer(BlockChalice.TileEntityChalice.class, new RenderChalice(), Item.func_150898_a(Witchery.Blocks.CHALICE));
      this.bindRenderer(BlockCandelabra.TileEntityCandelabra.class, new RenderCandelabra(), Item.func_150898_a(Witchery.Blocks.CANDELABRA));
      this.bindRenderer(BlockCrystalBall.TileEntityCrystalBall.class, new RenderCrystalBall(), Item.func_150898_a(Witchery.Blocks.CRYSTAL_BALL));
      this.bindRenderer(BlockKettle.TileEntityKettle.class, new RenderKettle(), Item.func_150898_a(Witchery.Blocks.KETTLE));
      this.bindRenderer(BlockLeechChest.TileEntityLeechChest.class, new RenderLeechChest(), Item.func_150898_a(Witchery.Blocks.LEECH_CHEST));
      this.bindRenderer(BlockStatueGoddess.TileEntityStatueGoddess.class, new RenderGoddess(), Item.func_150898_a(Witchery.Blocks.STATUE_GODDESS));
      this.bindRenderer(BlockSpinningWheel.TileEntitySpinningWheel.class, new RenderSpinningWheel(), Item.func_150898_a(Witchery.Blocks.SPINNING_WHEEL));
      this.bindRenderer(BlockBrazier.TileEntityBrazier.class, new RenderBrazier(), Item.func_150898_a(Witchery.Blocks.BRAZIER));
      this.bindRenderer(BlockAreaMarker.TileEntityAreaCurseProtect.class, new RenderStatueWolf(), Item.func_150898_a(Witchery.Blocks.DECURSE_DIRECTED));
      this.bindRenderer(BlockAreaMarker.TileEntityAreaTeleportPullProtect.class, new RenderStatueMandrake(), Item.func_150898_a(Witchery.Blocks.DECURSE_TELEPORT));
      this.bindRenderer(BlockStatueOfWorship.TileEntityStatueOfWorship.class, new RenderStatueOfWorship(), Item.func_150898_a(Witchery.Blocks.STATUE_OF_WORSHIP));
      this.bindRenderer(BlockPlacedItem.TileEntityPlacedItem.class, new RenderPlacedItem());
      this.bindRenderer(BlockAlluringSkull.TileEntityAlluringSkull.class, new RenderAlluringSkull());
      this.bindRenderer(BlockDemonHeart.TileEntityDemonHeart.class, new RenderDemonHeart());
      this.bindRenderer(TileEntityCauldron.class, new RenderCauldron(), Item.func_150898_a(Witchery.Blocks.CAULDRON));
      this.bindRenderer(BlockStatueWerewolf.TileEntityStatueWerewolf.class, new RenderStatueWerewolf(), Item.func_150898_a(Witchery.Blocks.WOLF_ALTAR));
      this.bindRenderer(BlockSilverVat.TileEntitySilverVat.class, new RenderSilverVat(), Item.func_150898_a(Witchery.Blocks.SILVER_VAT));
      this.bindRenderer(BlockBeartrap.TileEntityBeartrap.class, new RenderBeartrap(), Item.func_150898_a(Witchery.Blocks.BEARTRAP), Item.func_150898_a(Witchery.Blocks.WOLFTRAP));
      this.bindRenderer(BlockWolfHead.TileEntityWolfHead.class, new RenderWolfHead());
      this.bindRenderer(BlockCoffin.TileEntityCoffin.class, new RenderCoffin());
      this.bindRenderer(BlockGarlicGarland.TileEntityGarlicGarland.class, new RenderGarlicGarland());
      this.bindRenderer(BlockBloodCrucible.TileEntityBloodCrucible.class, new RenderBloodCrucible(), Item.func_150898_a(Witchery.Blocks.BLOOD_CRUCIBLE), Item.func_150898_a(Witchery.Blocks.BLOOD_CRUCIBLE));
      this.bindRenderer(BlockMirror.TileEntityMirror.class, new RenderMirror());
      RenderFumeFunnel funnelRenderer = new RenderFumeFunnel(false);
      this.bindRenderer(BlockFumeFunnel.TileEntityFumeFunnel.class, funnelRenderer);
      BlockFumeFunnel.TileEntityFumeFunnel dummyFunnelTile = new BlockFumeFunnel.TileEntityFumeFunnel();
      MinecraftForgeClient.registerItemRenderer(Item.func_150898_a(Witchery.Blocks.OVEN_FUMEFUNNEL), new RenderBlockItem(funnelRenderer, dummyFunnelTile));
      MinecraftForgeClient.registerItemRenderer(Item.func_150898_a(Witchery.Blocks.OVEN_FUMEFUNNEL_FILTERED), new RenderBlockItem(funnelRenderer, new BlockFumeFunnel.TileEntityFumeFunnel()));
      RenderFetish fetishRenderer = new RenderFetish();
      this.bindRenderer(BlockFetish.TileEntityFetish.class, fetishRenderer);
      BlockFetish.TileEntityFetish dummyFetishTile = new BlockFetish.TileEntityFetish();
      MinecraftForgeClient.registerItemRenderer(Item.func_150898_a(Witchery.Blocks.FETISH_SCARECROW), new RenderFetish.RenderFetishBlockItem(Witchery.Blocks.FETISH_SCARECROW, fetishRenderer, dummyFetishTile));
      MinecraftForgeClient.registerItemRenderer(Item.func_150898_a(Witchery.Blocks.FETISH_TREANT_IDOL), new RenderFetish.RenderFetishBlockItem(Witchery.Blocks.FETISH_TREANT_IDOL, fetishRenderer, dummyFetishTile));
   ...
   public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
      ...
      case 5:
         return new ItemBrewBagGUI(player.field_71071_by, new ItemBrewBag.InventoryBrewBag(player));
      case 6:
         return new GuiScreenBiomeBook(player, player.func_70694_bm());
      case 7:
         return new GuiScreenMarkupBook(player, player.func_70694_bm());
      case 8:
         return new ItemLeonardsUrnGUI(player.field_71071_by, new ItemLeonardsUrn.InventoryLeonardsUrn(player));
      default:
         return null;
      }
   }
   ...
   public EntityPlayer getPlayer(MessageContext ctx) {
      return (EntityPlayer)(ctx.side == Side.SERVER ? ctx.getServerHandler().field_147369_b : Minecraft.func_71410_x().field_71439_g);
   }
   ...
   public void showParticleEffect(World world, double x, double y, double z, double width, double height, SoundEffect sound, int color, ParticleEffect particle) {
      ...
      for(int i = 0; i < effectCount; ++i) {
         double d0 = world.field_73012_v.nextGaussian() * 0.02D;
         double d1 = world.field_73012_v.nextGaussian() * 0.02D;
         double d2 = world.field_73012_v.nextGaussian() * 0.02D;
         if (particle == ParticleEffect.SPELL_COLORED) {
            EntitySmokeFX sparkle = new EntitySmokeFX(world, x + world.field_73012_v.nextDouble() * width * 2.0D - width, y + world.field_73012_v.nextDouble() * height, z + (double)world.field_73012_v.nextFloat() * width * 2.0D - width, 0.0D, 0.0D, 0.0D);
            sparkle.field_70145_X = true;
            ...
            world.func_72869_a(particle.toString(), x + world.field_73012_v.nextDouble() * width * 2.0D - width, y + world.field_73012_v.nextDouble() * height, z + (double)world.field_73012_v.nextFloat() * width * 2.0D - width, 0.0D, 0.0D, 0.0D);
         }
      }
