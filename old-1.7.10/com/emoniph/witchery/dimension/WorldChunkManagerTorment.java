...
public class WorldChunkManagerTorment implements IChunkProvider {
   ...
   public Chunk func_73154_d(int x, int z) {
      ...
      for(y = 0; y < abyte.length; ++y) {
         abyte[y] = (byte)BiomeGenBase.field_76778_j.field_76756_M;
      }
      ...
      for(y = 0; y < 255; ++y) {
         ...
         if (extendedblockstorage == null) {
            extendedblockstorage = new ExtendedBlockStorage(y, !this.world.field_73011_w.field_76576_e);
         ...
         for(int _x = 0; _x < 16; ++_x) {
            for(int _z = 0; _z < 16; ++_z) {
               ...
               extendedblockstorage.func_76654_b(_x, y & 15, _z, 0);
            }
         }
      }
