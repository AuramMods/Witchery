...
public class EntityGoblinGulg extends EntityMob implements IBossDisplayData, IHandleDT {
   ...
   public EntityGoblinGulg(World world) {
      ...
      this.field_70714_bg.func_75776_a(3, new EntityAIMoveTowardsEntityClass(this, EntityGoblinMog.class, 1.0D, 6.0F, 64.0F));
      this.field_70714_bg.func_75776_a(4, new EntityAIMoveTowardsTarget(this, 1.0D, 48.0F));
   ...
   public String func_70005_c_() {
      return this.func_94056_bM() ? this.func_94057_bL() : StatCollector.func_74838_a("entity.witchery.goblingulg.name");
   }
   ...
   public boolean func_70652_k(Entity par1Entity) {
      ...
      boolean flag = par1Entity.func_70097_a(DamageSource.func_76358_a(this), (float)(6 + this.field_70146_Z.nextInt(force)));
      if (flag) {
         par1Entity.field_70181_x += 0.5D + height;
      }
   ...
   private double getDistanceSqToPartner() {
      ...
      List mogs = this.field_70170_p.func_72872_a(EntityGoblinMog.class, bb);
   ...
   protected void func_70628_a(boolean par1, int par2) {
      ...
      if (this.field_70170_p.field_73012_v.nextInt(2) == 0) {
         this.func_70099_a(new ItemStack(Witchery.Items.GULGS_GURDLE), 0.0F);
      }
