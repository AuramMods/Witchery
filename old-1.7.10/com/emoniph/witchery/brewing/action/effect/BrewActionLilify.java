...
public class BrewActionLilify extends BrewActionEffect {
   ...
   protected void doApplyToBlock(World world, int x, int y, int z, ForgeDirection side, int radius, ModifiersEffect modifiers, ItemStack actionStack) {
      ...
      for(z += side.offsetZ; (world.func_147439_a(x, y, z).func_149688_o() != Material.field_151586_h || !world.func_147437_c(x, y + 1, z)) && y < 255; ++y) {
      }

      if (world.func_147439_a(x, y, z).func_149688_o() == Material.field_151586_h && world.func_147437_c(x, y + 1, z) && BlockProtect.checkModsForBreakOK(world, x, y + 1, z, modifiers.caster)) {
