...
public class CommonProxy implements IGuiHandler {
   ...
   public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
      ...
      case 5:
         return new ItemBrewBag.ContainerBrewBag(player.field_71071_by, new ItemBrewBag.InventoryBrewBag(player), player.func_70694_bm());
      case 8:
         return new ItemLeonardsUrn.ContainerLeonardsUrn(player.field_71071_by, new ItemLeonardsUrn.InventoryLeonardsUrn(player), player.func_70694_bm());
      }
   }
   ...
   public EntityPlayer getPlayer(MessageContext ctx) {
      return ctx.side == Side.SERVER ? ctx.getServerHandler().field_147369_b : null;
   }
