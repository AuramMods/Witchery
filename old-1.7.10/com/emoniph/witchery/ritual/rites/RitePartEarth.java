      ...
      public RitualStep.Result process(World world, int posX, int posY, int posZ, long ticks, BlockCircle.TileEntityCircle.ActivatedRitual ritual) {
         if (this.stage == 0 && ticks % 20L != 0L) {
            ...
            if (++this.stage == 1 || this.coords.isEmpty()) {
               ...
               int last = ritual.sacrificedItems != null && !ritual.sacrificedItems.isEmpty() ? this.coord.getHeading(((RitualStep.SacrificedItem)ritual.sacrificedItems.get(0)).location) : 0;
               int probability = 20;
            ...
            if (!world.field_72995_K) {
               Coord c = (Coord)this.coords.get(this.stage + 4);
