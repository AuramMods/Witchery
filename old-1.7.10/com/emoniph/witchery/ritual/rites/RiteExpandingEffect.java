      ...
      public RitualStep.Result process(World world, int posX, int posY, int posZ, long ticks, BlockCircle.TileEntityCircle.ActivatedRitual ritual) {
         ...
         if (world.field_72995_K) {
            ...
            if ((float)currentRadius <= maxRadius && !this.applyCircle(world, posX, posZ, posY, currentRadius, height, player, enhanced)) {
               ...
               return this.stage <= 250 && !this.rite.isComplete(world, posX, posY, posZ, currentRadius, player, ticks, (float)currentRadius >= maxRadius, enhanced) ? RitualStep.Result.UPKEEP : RitualStep.Result.COMPLETED;
            }
         } else {
