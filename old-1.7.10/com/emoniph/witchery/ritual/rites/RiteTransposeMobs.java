   ...
   private static class StepTeleportation extends RitualStep {
      ...
      public RitualStep.Result process(World world, int posX, int posY, int posZ, long ticks, BlockCircle.TileEntityCircle.ActivatedRitual ritual) {
         if (ticks % 20L != 0L) {
            ...
            AxisAlignedBB bounds = AxisAlignedBB.func_72330_a((double)(posX - r), 1.0D, (double)(posZ - r), (double)(posX + r), (double)(posY - 1), (double)(posZ + r));
            Iterator i$ = world.func_72872_a(EntityMob.class, bounds).iterator();
