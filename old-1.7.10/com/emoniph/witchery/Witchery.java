...
public class Witchery {
   ...
   public void preInit(FMLPreInitializationEvent event) {
      ...
      config = new Configuration(new File(String.format("%s/%s.cfg", configDirectoryPath, "witchery")));
      config_debug = new Configuration(new File(String.format("%s/%s_debug.cfg", configDirectoryPath, "witchery")));
      ...
      if (Config.instance().generateApothecaries) {
         ...
         VillagerRegistry.instance().registerVillageTradeHandler(Config.instance().apothecaryID, villageApothecaryHandler);
   ...
   public void onMissingMappings(FMLMissingMappingsEvent event) {
      ...
      while(true) {
         ...
         do {
            ...
            missing = (MissingMapping)i$.next();
         } while(missing.name == null);
   ...
   public void postInit(FMLPostInitializationEvent event) {
      ...
      BlockDispenser.field_149943_a.func_82595_a(net.minecraft.init.Items.field_151069_bo, new DispenseBehaviourItemBrew());
