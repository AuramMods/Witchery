...
public abstract class BlockActionSphere {
   ...
   private void fillHalfWithAirZ(World world, int posX, int posY, int posZ, int dz, int radius, Block fillBlock, Block edgeBlock) {
      for(int z = 0; z <= radius; ++z) {
         ...
         if (foundBlock != fillBlock && (foundBlock == Blocks.field_150355_j || foundBlock == Blocks.field_150358_i || foundBlock == Witchery.Blocks.BREW_GAS || foundBlock == Witchery.Blocks.BREW_LIQUID)) {
