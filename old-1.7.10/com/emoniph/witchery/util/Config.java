...
public class Config {
   ...
   private List<Config.BlockMeta> naturePowerReplaceableBlocks;
   ...
   public List<Config.Building> townParts;
   ...
   public void sync() {
      ...
      this.spawnWeightSpirit = MathHelper.func_76125_a(this.configuration.get("general", "SpiritSpawnWeight", 1).getInt(), 1, 1000);
      ...
      this.fairestSpawnChance = MathHelper.func_151237_a(this.configuration.get("general", "NewFairestOfThemAllSpawnChance", 0.01D).getDouble(0.01D), 0.01D, 1.0D);
      ...
      this.riteOfEclipseCooldownInSecs = MathHelper.func_76125_a(this.configuration.get("general", "RiteOfEclipseCooldownInSecs", 0).getInt(), 0, 3600);
   ...
   public static class Building {
      ...
      public final Class<? extends Village> clazz;
