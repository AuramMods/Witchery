...
public class BlockWitchCrop extends BlockBaseBush implements IGrowable {
      ...
      if (!world.field_72995_K) {
         ...
         if (current == stages) {
            ...
            if (!this.canFertilize) {
               ...
               l = current + MathHelper.func_76136_a(world.field_73012_v, 2, stages);
            }
   ...
   public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune) {
      ...
      if (metadata >= this.getNumGrowthStages()) {
         if (Witchery.Items.GENERIC.itemMandrakeRoot.isMatch(this.cropItemPrototype) && world.field_73013_u != EnumDifficulty.PEACEFUL && (!world.field_73011_w.isDaytime() || !(world.field_73012_v.nextDouble() > 0.9D)) && (world.field_73011_w.isDaytime() || !(world.field_73012_v.nextDouble() > 0.1D))) {
            if (!world.field_72995_K) {
               EntityMandrake mandrake = new EntityMandrake(world);
               mandrake.func_70012_b(0.5D + (double)x, 0.05D + (double)y, 0.5D + (double)z, 0.0F, 0.0F);
         ...
         } else if (this.cropItemPrototype.func_77973_b() == Witchery.Items.SEEDS_MINDRAKE) {
            ...
            for(i = 0; i < this.func_149745_a(world.field_73012_v); ++i) {
               ret.add(this.getCropItemStack());
            }
