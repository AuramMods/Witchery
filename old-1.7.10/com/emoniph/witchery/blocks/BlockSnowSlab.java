...
public class BlockSnowSlab extends BlockSlab {
   public BlockSnowSlab(boolean doubleSlab) {
      super(doubleSlab, Material.field_151597_y);
   ...
   public IIcon func_149691_a(int p_149691_1_, int p_149691_2_) {
      return Blocks.field_150433_aE.func_149691_a(p_149691_1_, p_149691_2_ & 7);
   }

   public Item func_149650_a(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
      return Item.func_150898_a(Witchery.Blocks.SNOW_SLAB_SINGLE);
   }

   protected ItemStack func_149644_j(int p_149644_1_) {
      return new ItemStack(Item.func_150898_a(Witchery.Blocks.SNOW_SLAB_SINGLE), 2, p_149644_1_ & 7);
   }
   ...
   public Item func_149694_d(World p_149694_1_, int p_149694_2_, int p_149694_3_, int p_149694_4_) {
      return this.field_150004_a ? Witchery.Items.SNOW_SLAB_DOUBLE : Witchery.Items.SNOW_SLAB_SINGLE;
   }
