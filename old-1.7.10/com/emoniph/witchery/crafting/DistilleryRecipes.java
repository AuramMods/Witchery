...
public class DistilleryRecipes {
   ...
   public final ArrayList<DistilleryRecipes.DistilleryRecipe> recipes = new ArrayList();
   ...
   public DistilleryRecipes.DistilleryRecipe addRecipe(ItemStack input1, ItemStack input2, int jars, ItemStack output1, ItemStack output2, ItemStack output3, ItemStack output4) {
      DistilleryRecipes.DistilleryRecipe recipe = new DistilleryRecipes.DistilleryRecipe(input1, input2, jars, output1, output2, output3, output4);
   ...
   public static class DistilleryRecipe {
      ...
      // $FF: synthetic method
      DistilleryRecipe(ItemStack x0, ItemStack x1, int x2, ItemStack x3, ItemStack x4, ItemStack x5, ItemStack x6, Object x7) {
