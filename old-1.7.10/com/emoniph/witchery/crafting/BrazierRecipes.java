...
public class BrazierRecipes {
   ...
   public final ArrayList<BrazierRecipes.BrazierRecipe> recipes = new ArrayList();
   public static final BrazierRecipes.BrazierRecipe SPECTRES;
   public static final BrazierRecipes.BrazierRecipe BANSHEES;
   public static final BrazierRecipes.BrazierRecipe POLTERGEIST;
   public static final BrazierRecipes.BrazierRecipe SMOKE;
   public static final BrazierRecipes.BrazierRecipe STRONG;
   public static final BrazierRecipes.BrazierRecipe TOUGH;
   public static final BrazierRecipes.BrazierRecipe INVISIBLE;
   public static final BrazierRecipes.BrazierRecipe WILTING;
   ...
   static {
      SPECTRES = new BrazierRecipes.BrazierRecipe("witchery.brazier.spectre", true, TimeUtil.secsToTicks(30), new ItemStack[]{Witchery.Items.GENERIC.itemWormwood.createStack(), Witchery.Items.GENERIC.itemBatWool.createStack(), Witchery.Items.GENERIC.itemGraveyardDust.createStack()}) {
      ...
      BANSHEES = new BrazierRecipes.BrazierRecipe("witchery.brazier.banshee", true, TimeUtil.secsToTicks(30), new ItemStack[]{Witchery.Items.GENERIC.itemWormwood.createStack(), Witchery.Items.GENERIC.itemCondensedFear.createStack(), Witchery.Items.GENERIC.itemGraveyardDust.createStack()}) {
         public int onBurning(World world, int x, int y, int z, long ticks, BlockBrazier.TileEntityBrazier tile) {
            if (TimeUtil.secondsElapsed(5, ticks)) {
               ParticleEffect.INSTANT_SPELL.send(SoundEffect.NONE, world, 0.5D + (double)x, 1.0D + (double)y, 0.5D + (double)z, 0.5D, 1.0D, 16);
            }
      ...
      POLTERGEIST = new BrazierRecipes.BrazierRecipe("witchery.brazier.poltergeist", false, TimeUtil.secsToTicks(45), new ItemStack[]{Witchery.Items.GENERIC.itemWormwood.createStack(), Witchery.Items.GENERIC.itemRefinedEvil.createStack(), Witchery.Items.GENERIC.itemFocusedWill.createStack()}) {
         public int onBurning(World world, int x, int y, int z, long ticks, BlockBrazier.TileEntityBrazier tile) {
            if (TimeUtil.secondsElapsed(5, ticks)) {
               ParticleEffect.INSTANT_SPELL.send(SoundEffect.NONE, world, 0.5D + (double)x, 1.0D + (double)y, 0.5D + (double)z, 0.5D, 1.0D, 16);
            }
      ...
      SMOKE = new BrazierRecipes.BrazierRecipe("witchery.brazier.smoke", true, TimeUtil.minsToTicks(5), new ItemStack[]{new ItemStack(Items.field_151016_H), Witchery.Items.GENERIC.itemQuicklime.createStack(), new ItemStack(Items.field_151114_aO)}) {
         public int onBurning(World world, int x, int y, int z, long ticks, BlockBrazier.TileEntityBrazier tile) {
            ParticleEffect.EXPLODE.send(SoundEffect.NONE, world, 0.5D + (double)x, (double)y, 0.5D + (double)z, 16.0D, 4.0D, 64);
            return 0;
         }
      };
      STRONG = new BrazierRecipes.BrazierRecipe("witchery.brazier.strong", true, TimeUtil.minsToTicks(5), new ItemStack[]{Witchery.Items.GENERIC.itemTearOfTheGoddess.createStack(), new ItemStack(Items.field_151103_aS), new ItemStack(Items.field_151065_br)}) {
         public int onBurning(World world, int x, int y, int z, long ticks, BlockBrazier.TileEntityBrazier tile) {
            if (TimeUtil.secondsElapsed(3, ticks)) {
               int radius = true;
               int radiusSq = true;
               AxisAlignedBB bb = AxisAlignedBB.func_72330_a(0.5D + (double)x - 4.0D, (double)(y - 4), 0.5D + (double)z - 4.0D, 0.5D + (double)x + 4.0D, (double)(y + 4), 0.5D + (double)z + 4.0D);
               ...
               while(i$.hasNext()) {
                  ...
                  if (entity.func_70092_e(0.5D + (double)x, (double)y, 0.5D + (double)z) <= 16.0D) {
      ...
      TOUGH = new BrazierRecipes.BrazierRecipe("witchery.brazier.tough", true, TimeUtil.minsToTicks(5), new ItemStack[]{Witchery.Items.GENERIC.itemTearOfTheGoddess.createStack(), new ItemStack(Items.field_151078_bh), new ItemStack(Items.field_151065_br)}) {
         public int onBurning(World world, int x, int y, int z, long ticks, BlockBrazier.TileEntityBrazier tile) {
            if (TimeUtil.secondsElapsed(3, ticks)) {
               int radius = true;
               int radiusSq = true;
      ...
      INVISIBLE = new BrazierRecipes.BrazierRecipe("witchery.brazier.invisible", true, TimeUtil.minsToTicks(10), new ItemStack[]{new ItemStack(Items.field_151079_bi), new ItemStack(Items.field_151070_bp), new ItemStack(Items.field_151072_bj)}) {
         public int onBurning(World world, int x, int y, int z, long ticks, BlockBrazier.TileEntityBrazier tile) {
            if (TimeUtil.secondsElapsed(3, ticks)) {
               int radius = true;
               int radiusSq = true;
               AxisAlignedBB bb = AxisAlignedBB.func_72330_a(0.5D + (double)x - 6.0D, (double)(y - 6), 0.5D + (double)z - 6.0D, 0.5D + (double)x + 6.0D, (double)(y + 6), 0.5D + (double)z + 6.0D);
               List entities = world.func_72872_a(EntityLivingBase.class, bb);
               Iterator i$ = entities.iterator();
               ...
               while(i$.hasNext()) {
                  Object obj = i$.next();
                  EntityLivingBase entity = (EntityLivingBase)obj;
                  if (entity.func_70092_e(0.5D + (double)x, (double)y, 0.5D + (double)z) <= 36.0D) {
      ...
      WILTING = new BrazierRecipes.BrazierRecipe("witchery.brazier.wilting", true, TimeUtil.minsToTicks(1), new ItemStack[]{Witchery.Items.GENERIC.itemCondensedFear.createStack(), Witchery.Items.GENERIC.itemWormyApple.createStack(), Witchery.Items.GENERIC.itemGraveyardDust.createStack()}) {
         public int onBurning(World world, int x, int y, int z, long ticks, BlockBrazier.TileEntityBrazier tile) {
            if (ticks % 5L == 0L) {
               ...
               int posZ = z - 3 + world.field_73012_v.nextInt(7);
         ...
         private void healNearbyUndead(World world, int x, int y, int z, int radius) {
            ...
            while(i$.hasNext()) {
               ...
               if (CreatureUtil.isUndead(entity)) {
                  ...
                  if (entity.func_110143_aJ() < maxHealth) {
   ...
   public static class BrazierRecipe {
      ...
      private boolean isMatch(ItemStack[] availableItems) {
         ArrayList<ItemStack> availableItemList = new ArrayList();
